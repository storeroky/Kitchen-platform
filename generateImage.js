...
export async function generateKitchenImage({ prompt, style, material, dimensions, referenceImage }) {
  const res = await fetch(`${API_BASE}/api/generate-design`, {
    method: 'POST',
    headers: { 'Content-Type': 'application/json' },
    body: JSON.stringify({ prompt, style, material, dimensions, referenceImage })
  })
