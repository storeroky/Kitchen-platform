...
4. **رفع صورة 2D مُصدّرة من SketchUp** (مخطط علوي أو واجهة أمامية) وتحويلها مباشرة إلى تصميم واقعي احترافي، مع الحفاظ على نفس تكوين وأبعاد المخطط الأصلي.
5. تصدير بطاقة تصميم احترافية جاهزة للطباعة/المشاركة (PNG) بنفس هوية "رقي" البصرية.

### 🖼️ كيف يعمل تحويل صور SketchUp؟
في خطوة "المواد والذكاء الاصطناعي"، اختر تبويب **"تحويل صورة SketchUp"**، ثم ارفع صورة PNG/JPG (حتى 8 ميجابايت) مُصدّرة من SketchUp. يرسل النظام الصورة إلى مزوّد الذكاء الاصطناعي مع تعليمات صريحة بالحفاظ على نفس التخطيط والأبعاد، وينتج تصميماً واقعياً بنفس الأسلوب الفاخر.
- مع **OpenAI**: يُستخدم مسار `images/edits` (نموذج `gpt-image-1`).
- مع **Stability AI**: يُستخدم مسار `control/structure` المصمم خصيصاً للحفاظ على خطوط وتكوين الرسم الأصلي.
